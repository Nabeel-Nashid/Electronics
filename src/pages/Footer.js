    ...
    <div className="w-full md:h-[400px] h-full bg-[#e7f0f8] flex flex-col justify-center">
      <div className="grid grid-cols-2 ml-7 mt-7 md:mt-0 md:ml-0 md:flex flex-row md:justify-evenly text-[#162c53]">
        ...
        <div className="flex flex-col">
          ...
          <h1 className="mb-2 font-medium md:text-base text-xs">Accesories</h1>
          <h1 className="mb-2 font-medium md:text-base text-xs">Gadgets</h1>
          <h1 className="mb-2 font-medium md:text-base text-xs">Laptops & Computers</h1>
          <h1 className="mb-2 font-medium md:text-base text-xs">Smart Phones & Tablets</h1>
        </div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="text-[#162c53] font-medium text-[11px] mb-4 md:mb-0 sm:text-lg">© All Right Reserved</div>
      </div>
    </div>
  );
}
